...
the twin is a container right beside it, reached at localhost. This endpoint gives
deploy.py the same `(rc, out, err)` interface an SSHEndpoint has, but executes
locally instead of over SSH — no second hop, no tunnel.
"""
